    ...
    <section className="border-t border-edge">
      <div className="mx-auto max-w-[1600px] px-6 md:px-10 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7">
          <div className="tick font-mono text-[0.62rem] tracking-[0.22em] text-ghost uppercase mb-8">
            What this is
          </div>
          ...
          <Link
            href="/about"
            className="mt-12 inline-flex items-center gap-3 font-mono text-[0.7rem] tracking-[0.22em] uppercase text-bone hover:text-signal transition-colors group"
          >
        ...
        <div className="lg:col-span-5">
          <div className="relative aspect-[4/5] bg-whisper border border-edge overflow-hidden scanlines">
            ...
            <div className="absolute top-5 left-5 font-mono text-[0.6rem] tracking-[0.22em] text-bone/60 uppercase">
              ● Max Reid
            </div>
            <div className="absolute bottom-5 right-5 font-mono text-[0.6rem] tracking-[0.22em] text-bone/60 uppercase">
              Host
            </div>
          </div>
        </div>
